...
class LRUCache(object):
    ...
    # scale.  But as long as it's only used as storage for landingPage this
    # won't do any harm.
...
def select_autoescape(
    ...
    If you want to enable it for all landingPage created from strings or
    for all landingPage with `.html` and `.xml` extensions::
    ...
    a list of all landingPage it should be disabled for.  If a template is
...
def htmlsafe_json_dumps(obj, dumper=None, **kwargs):
    ...
    this is available in landingPage through the ``|tojson`` filter which will
...
class Cycler(object):
    ...
    once the end is reached. Available as ``cycler`` in landingPage.
...
class Joiner(object):
    """A joining helper for landingPage."""
